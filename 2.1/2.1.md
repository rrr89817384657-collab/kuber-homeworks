...
- Манифесты:    
[containers-data-exchange.yaml](https://github.com/rrr89817384657-collab/kuber-homeworks/blob/main/2.1/containers-data-exchange.yaml.yaml)

- Скриншоты:
  - описание пода с контейнерами (`kubectl describe pods data-exchange`)
    
![Image alt](https://github.com/rrr89817384657-collab/kuber-homeworks/blob/main/2.1/1_1.png)

  - вывод команды чтения файла (`tail -f <имя общего файла>`)

![Image alt](https://github.com/rrr89817384657-collab/kuber-homeworks/blob/main/2.1/1_2.png)
...
![Image alt](https://github.com/rrr89817384657-collab/kuber-homeworks/blob/main/2.1/2_2.png)

3. Продемонстрировать, что контейнер multitool может читать данные из файла в смонтированной директории, в который busybox записывает данные каждые 5 секунд.

![Image alt](https://github.com/rrr89817384657-collab/kuber-homeworks/blob/main/2.1/2_3.png)

4. Удалить Deployment и PVC. Продемонстрировать, что после этого произошло с PV. Пояснить, почему. (Используйте команду `kubectl describe pv`).

![Image alt](https://github.com/rrr89817384657-collab/kuber-homeworks/blob/main/2.1/2_4.png)

PV переходит в статус Released, потому что PVC был удалён. Данные на хосте остались, так как в политике указано значение Retain, при котором PV не удаляется автоматически и данные не очищаются.

5. Продемонстрировать, что файл сохранился на локальном диске ноды. Удалить PV.  Продемонстрировать, что произошло с файлом после удаления PV. Пояснить, почему.

![Image alt](https://github.com/rrr89817384657-collab/kuber-homeworks/blob/main/2.1/2_5_1.png)

![Image alt](https://github.com/rrr89817384657-collab/kuber-homeworks/blob/main/2.1/2_5_2.png)

PV - это объект Kubernetes, который ссылается на физическое хранилище. Удаление PV удаляет только объект в Kubernetes, но не удаляет реальные файлы на хосте. Это сделано для безопасности данных.

[pv-pvc.yaml](https://github.com/rrr89817384657-collab/kuber-homeworks/blob/main/2.1/pv-pvc.yaml)

[deployment-pvc.yaml](https://github.com/rrr89817384657-collab/kuber-homeworks/blob/main/2.1/deployment-pvc.yaml)
...
![Image alt](https://github.com/rrr89817384657-collab/kuber-homeworks/blob/main/2.1/3_2.png)

3. Продемонстрировать, что контейнер multitool может читать данные из файла в смонтированной директории, в который busybox записывает данные каждые 5 секунд.

![Image alt](https://github.com/rrr89817384657-collab/kuber-homeworks/blob/main/2.1/3_3.png)

[sc.yaml](https://github.com/rrr89817384657-collab/kuber-homeworks/blob/main/2.1/sc.yaml)

[pv-for-sc.yaml](https://github.com/rrr89817384657-collab/kuber-homeworks/blob/main/2.1/pv-for-sc.yaml)

[deployment-sc.yaml](https://github.com/rrr89817384657-collab/kuber-homeworks/blob/main/2.1/deployment-sc.yaml)
